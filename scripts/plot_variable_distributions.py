...
# cat_vars = ['region', 'residence', 'ch_sex', 'ch_longterm_health_problem', ...]  # list all categorical vars
# cont_vars = ['age_months', 'waz', 'haz', 'whz', ...]  # list all continuous vars
# plot_categorical_vars(df, cat_vars, "results/figures/categorical")
# plot_continuous_vars(df, cont_vars, "results/figures/continuous")
